...
const Home = () => {
  ...
  return (
    //TODO: Arrumar o padding do keyboardAvoid
    <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
      <ImageBackground source={require('../../assets/home-background.png')} style={styles.container} imageStyle={{ width: 274, height: 368 }} >
        ...
        <View style={styles.footer}>
          <TextInput style={styles.input} maxLength={2} autoCapitalize="characters" autoCorrect={false} placeholder="Digite o UF" value={uf} onChangeText={setUf} />
